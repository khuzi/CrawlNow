...
import { rightUrl } from "../utils/methods/functions";
      ...
      <Grid container style={{ height: "100vh" }} justify="space-between">
        <Grid container direction="column" justify="center" item xs={12} md={4}>
          ...
          <form className={classes.form}>
            <InputAdmin
              label={loginData[0].name}
              placeholder={loginData[0].placehlder}
              type="text"
              setValue={setAdminEmail}
            />
            <InputAdmin
              label={loginData[1].name}
              placeholder={loginData[1].placehlder}
              type="password"
              ...
              <button
                ...
                onClick={(e) => {
                  ...
                  const url = {
                    ...
                    remote: `https://admin-beta-1.vercel.app/api/admin/adminLogin`,
                  };

                  axios
                    .post(rightUrl("adminLogin"), {
                      email: adminEmail,
